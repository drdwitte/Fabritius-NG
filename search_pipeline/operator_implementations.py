...
class OperatorFactory:
    ...
    Maps operator names to their concrete implementations.
    This is the central registry for all available operators.
    """
    
    _operators: Dict[str, type[Operator]] = {
        'Semantic Search': SemanticSearchOperator,
        'Metadata Filter': MetadataFilterOperator,
        'Similarity Search': SimilaritySearchOperator,
    }
    ...
    def create(cls, operator_name: str) -> Operator:
        ...
        """
        operator_class = cls._operators.get(operator_name)
    ...
    @classmethod
    def register(cls, operator_name: str, operator_class: type[Operator]):
        """
        Register a new operator type.
        
        Args:
            operator_name: Name to register operator under
            operator_class: Operator class to register
        """
        cls._operators[operator_name] = operator_class
